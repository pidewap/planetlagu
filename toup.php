...
/*--------------------------------------------------
 ...
 | Copyright (c) 2004-2016 FabrÃ­cio Seger Kolling
...
function get_client_ip() {
    ...
    // proxy transparente nÃ£o esconde o IP local, colocando ele apÃ³s o IP da rede, separado por vÃ­rgula
...
function getServerURL() {
    ...
    $url .= $_SERVER["SERVER_NAME"]; // variÃ¡vel do servidor, $_SERVER["HTTP_HOST"] Ã© equivalente
...
function remove_special_chars($str){
    $str = trim($str);
    $str = strtr($str,"Â¥ÂµÃ€ÃÃ‚ÃƒÃ„Ã…Ã†Ã‡ÃˆÃ‰ÃŠÃ‹ÃŒÃÃŽÃÃÃ‘Ã’Ã“Ã”Ã•Ã–Ã˜Ã™ÃšÃ›ÃœÃÃŸÃ Ã¡Ã¢Ã£Ã¤Ã¥Ã¦Ã§Ã¨Ã©ÃªÃ«Ã¬Ã­Ã®Ã¯Ã°Ã±Ã²Ã³Ã´ÃµÃ¶Ã¸Ã¹ÃºÃ»Ã¼Ã½Ã¿!@#%&*()[]{}+=?",
        ...
        while ($file = readdir($opdir)) {
          if (($file != ".")&&($file != "..")){
            ...
            if (is_file($current_dir.$file)){
                ...
                // FunÃ§Ã£o filetype() returns only "file"...
...
function view_form(){
    ...
    if (intval($passthru)){
        ...
        if ($is_reachable_thru_webserver){
            ...
            // Malditas variaveis de sistema!! No windows doc_root Ã© sempre em lowercase... cadÃª o str_ireplace() ??
...
function config_form(){
    ...
    if ($reload){
        ...
        <select name=newlang style=\"width:406px\">
            ...
            <option value='ca'>Catalan - by Pere BorrÃ s AKA @Norl
            ...
            <option value='it2'>Italian - by Federico CorrÃ 
            ...
            <option value='ru'>Russian - by Ð•Ð²Ð³ÐµÐ½Ð¸Ð¹ Ð Ð°ÑˆÐµÐ²
...
function et($tag){
    ...
    $et['pt']['SaveConfig'] = 'Salvar ConfiguraÃ§Ãµes';
    ...
    $et['pt']['Configurations'] = 'ConfiguraÃ§Ãµes';
    $et['pt']['JSError'] = 'Erro de JavaScript';
    $et['pt']['NoSel'] = 'NÃ£o hÃ¡ itens selecionados';
    $et['pt']['SelDir'] = 'Selecione o diretÃ³rio de destino na Ã¡rvore a esquerda';
    $et['pt']['TypeDir'] = 'Digite o nome do diretÃ³rio';
    $et['pt']['TypeArq'] = 'Digite o nome do arquivo';
    $et['pt']['TypeCmd'] = 'Digite o commando';
    $et['pt']['TypeArqComp'] = 'Digite o nome do arquivo.\\nA extensÃ£o determina o tipo de compactaÃ§Ã£o.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $et['pt']['RemSel'] = 'APAGAR itens selecionados';
    $et['pt']['NoDestDir'] = 'NÃ£o hÃ¡ um diretÃ³rio de destino selecionado';
    $et['pt']['DestEqOrig'] = 'DiretÃ³rio de origem e destino iguais';
    $et['pt']['InvalidDest'] = 'DiretÃ³rio de destino invÃ¡lido';
    $et['pt']['NoNewPerm'] = 'Nova permissÃ£o nÃ£o foi setada';
    $et['pt']['CopyTo'] = 'COPIAR para';
    $et['pt']['MoveTo'] = 'MOVER para';
    $et['pt']['AlterPermTo'] = 'ALTERAR PERMISSÃ•ES para';
    $et['pt']['ConfExec'] = 'Confirma EXECUTAR';
    $et['pt']['ConfRem'] = 'Confirma APAGAR';
    $et['pt']['EmptyDir'] = 'DiretÃ³rio vazio';
    $et['pt']['IOError'] = 'Erro de E/S';
    $et['pt']['FileMan'] = 'PHP File Manager';
    $et['pt']['TypePass'] = 'Digite a senha';
    $et['pt']['InvPass'] = 'Senha InvÃ¡lida';
    $et['pt']['ReadDenied'] = 'Acesso de leitura negado';
    $et['pt']['FileNotFound'] = 'Arquivo nÃ£o encontrado';
    $et['pt']['AutoClose'] = 'Fechar Automaticamente';
    $et['pt']['OutDocRoot'] = 'Arquivo fora do DOCUMENT_ROOT';
    $et['pt']['NoCmd'] = 'Erro: Comando nÃ£o informado';
    $et['pt']['ConfTrySave'] = 'Arquivo sem permissÃ£o de escrita.\\nTentar salvar assim mesmo';
    $et['pt']['ConfSaved'] = 'ConfiguraÃ§Ãµes salvas';
    $et['pt']['PassSaved'] = 'Senha salva';
    $et['pt']['FileDirExists'] = 'Arquivo ou diretÃ³rio jÃ¡ existe';
    $et['pt']['NoPhpinfo'] = 'FunÃ§Ã£o phpinfo desabilitada';
    $et['pt']['NoReturn'] = 'sem retorno';
    $et['pt']['FileSent'] = 'Arquivo enviado';
    $et['pt']['SpaceLimReached'] = 'Limite de espaÃ§o alcanÃ§ado';
    $et['pt']['InvExt'] = 'ExtensÃ£o invÃ¡lida';
    $et['pt']['FileNoOverw'] = 'Arquivo nÃ£o pode ser sobreescrito';
    $et['pt']['FileOverw'] = 'Arquivo sobreescrito';
    $et['pt']['FileIgnored'] = 'Arquivo omitido';
    $et['pt']['ChkVer'] = 'Verificar por nova versÃ£o';
    $et['pt']['ChkVerAvailable'] = 'Nova versÃ£o, clique aqui para iniciar download!!';
    $et['pt']['ChkVerNotAvailable'] = 'NÃ£o hÃ¡ nova versÃ£o disponÃ­vel. :(';
    $et['pt']['ChkVerError'] = 'Erro de conexÃ£o.';
    ...
    $et['pt']['Total'] = 'total';
    $et['pt']['Partition'] = 'PartiÃ§Ã£o';
    $et['pt']['RenderTime'] = 'Tempo para gerar esta pÃ¡gina';
    $et['pt']['Seconds'] = 'seg';
    $et['pt']['ErrorReport'] = 'Error Reporting';

    // Spanish - by Sh Studios
    $et['es']['Version'] = 'VersiÃ³n';
    ...
    $et['es']['SavePass'] = 'Cuardar ContraseÃ±a';
    ...
    $et['es']['TypePass'] = 'Escriba la contraseÃ±a';
    $et['es']['InvPass'] = 'ContraseÃ±a invalida';
    ...
    $et['es']['PassSaved'] = 'ContraseÃ±a guardada';
    ...
    // Korean - by Airplanez
    $et['ko']['Version'] = 'ë²„ì „';
    $et['ko']['DocRoot'] = 'ì›¹ì„œë²„ ë£¨íŠ¸';
    $et['ko']['FLRoot'] = 'íŒŒì¼ ë§¤ë‹ˆì € ë£¨íŠ¸';
    $et['ko']['Name'] = 'ì´ë¦„';
    $et['ko']['Enter'] = 'ìž…ë ¥';
    $et['ko']['Send'] = 'ì „ì†¡';
    $et['ko']['Refresh'] = 'ìƒˆë¡œê³ ì¹¨';
    $et['ko']['SaveConfig'] = 'í™˜ê²½ ì €ìž¥';
    $et['ko']['SavePass'] = 'ë¹„ë°€ë²ˆí˜¸ ì €ìž¥';
    $et['ko']['SaveFile'] = 'íŒŒì¼ ì €ìž¥';
    $et['ko']['Save'] = 'ì €ìž¥';
    $et['ko']['Leave'] = 'ë‚˜ê°€ê¸°';
    $et['ko']['Edit'] = 'ìˆ˜ì •';
    $et['ko']['View'] = 'ë³´ê¸°';
    ...
    $et['ko']['Ren'] = 'ì´ë¦„ë°”ê¾¸ê¸°';
    $et['ko']['Rem'] = 'ì‚­ì œ';
    $et['ko']['Compress'] = 'ì••ì¶•í•˜ê¸°';
    $et['ko']['Decompress'] = 'ì••ì¶•í’€ê¸°';
    $et['ko']['ResolveIDs'] = 'ì†Œìœ ìž';
    $et['ko']['Move'] = 'ì´ë™';
    $et['ko']['Copy'] = 'ë³µì‚¬';
    $et['ko']['ServerInfo'] = 'ì„œë²„ ì •ë³´';
    $et['ko']['CreateDir'] = 'ë””ë ‰í† ë¦¬ ìƒì„±';
    $et['ko']['CreateArq'] = 'íŒŒì¼ ìƒì„±';
    $et['ko']['ExecCmd'] = 'ëª…ë ¹ ì‹¤í–‰';
    $et['ko']['Upload'] = 'ì—…ë¡œë“œ';
    $et['ko']['UploadEnd'] = 'ì—…ë¡œë“œê°€ ì™„ë£Œë˜ì—ˆìŠµë‹ˆë‹¤.';
    $et['ko']['Perm'] = 'ê¶Œí•œ';
    $et['ko']['Perms'] = 'ê¶Œí•œ';
    $et['ko']['Owner'] = 'ì†Œìœ ìž';
    $et['ko']['Group'] = 'ê·¸ë£¹';
    $et['ko']['Other'] = 'ëª¨ë“ ì‚¬ìš©ìž';
    $et['ko']['Size'] = 'í¬ê¸°';
    $et['ko']['Date'] = 'ë‚ ì§œ';
    $et['ko']['Type'] = 'ì¢…ë¥˜';
    $et['ko']['Free'] = 'ì—¬ìœ ';
    ...
    $et['ko']['Exec'] = 'ì‹¤í–‰';
    $et['ko']['Apply'] = 'ì ìš©';
    $et['ko']['StickyBit'] = 'ìŠ¤í‹°í‚¤ ë¹„íŠ¸';
    $et['ko']['Pass'] = 'ë¹„ë°€ë²ˆí˜¸';
    $et['ko']['Lang'] = 'ì–¸ì–´';
    $et['ko']['File'] = 'íŒŒì¼';
    $et['ko']['File_s'] = 'íŒŒì¼';
    $et['ko']['To'] = 'ìœ¼ë¡œ';
    $et['ko']['Destination'] = 'ëŒ€ìƒ';
    $et['ko']['Configurations'] = 'í™˜ê²½';
    $et['ko']['JSError'] = 'ìžë°”ìŠ¤í¬ë¦½íŠ¸ ì˜¤ë¥˜';
    $et['ko']['NoSel'] = 'ì„ íƒëœ ê²ƒì´ ì—†ìŠµë‹ˆë‹¤';
    $et['ko']['SelDir'] = 'ì™¼ìª½ë¦¬ìŠ¤íŠ¸ì—ì„œ ëŒ€ìƒ ë””ë ‰í† ë¦¬ë¥¼ ì„ íƒí•˜ì„¸ìš”';
    $et['ko']['TypeDir'] = 'ë””ë ‰í† ë¦¬ëª…ì„ ìž…ë ¥í•˜ì„¸ìš”';
    $et['ko']['TypeArq'] = 'íŒŒì¼ëª…ì„ ìž…ë ¥í•˜ì„¸ìš”';
    $et['ko']['TypeCmd'] = 'ëª…ë ¹ì„ ìž…ë ¥í•˜ì„¸ìš”';
    $et['ko']['TypeArqComp'] = 'íŒŒì¼ëª…ì„ ìž…ë ¥í•˜ì„¸ìš”.\\ní™•ìž¥ìžì— ë”°ë¼ ì••ì¶•í˜•ì‹ì´ ì •í•´ì§‘ë‹ˆë‹¤.\\nì˜ˆ:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $et['ko']['RemSel'] = 'ì„ íƒëœ ê²ƒì„ ì‚­ì œí–ˆìŠµë‹ˆë‹¤';
    $et['ko']['NoDestDir'] = 'ì„ íƒëœ ëŒ€ìƒ ë””ë ‰í† ë¦¬ê°€ ì—†ìŠµë‹ˆë‹¤.';
    $et['ko']['DestEqOrig'] = 'ì›ëž˜ ë””ë ‰í† ë¦¬ì™€ ëŒ€ìƒ ë””ë ‰í† ë¦¬ê°€ ê°™ìŠµë‹ˆë‹¤';
    $et['ko']['NoNewPerm'] = 'ìƒˆë¡œìš´ ê¶Œí•œì´ ì„¤ì •ë˜ì§€ ì•Šì•˜ìŠµë‹ˆë‹¤';
    $et['ko']['CopyTo'] = 'ì—¬ê¸°ì— ë³µì‚¬';
    $et['ko']['MoveTo'] = 'ì—¬ê¸°ë¡œ ì´ë™';
    $et['ko']['AlterPermTo'] = 'ìœ¼ë¡œ ê¶Œí•œë³€ê²½';
    $et['ko']['ConfExec'] = 'ì‹¤í–‰ í™•ì¸';
    $et['ko']['ConfRem'] = 'ì‚­ì œ í™•ì¸';
    $et['ko']['EmptyDir'] = 'ë¹ˆ ë””ë ‰í† ë¦¬';
    $et['ko']['IOError'] = 'ìž…/ì¶œë ¥ ì˜¤ë¥˜';
    $et['ko']['FileMan'] = 'PHP íŒŒì¼ ë§¤ë‹ˆì €';
    $et['ko']['TypePass'] = 'ë¹„ë°€ë²ˆí˜¸ë¥¼ ìž…ë ¥í•˜ì„¸ìš”';
    $et['ko']['InvPass'] = 'ë¹„ë°€ë²ˆí˜¸ê°€ í‹€ë¦½ë‹ˆë‹¤';
    $et['ko']['ReadDenied'] = 'ì½ê¸°ê°€ ê±°ë¶€ë˜ì—ˆìŠµë‹ˆë‹¤';
    $et['ko']['FileNotFound'] = 'íŒŒì¼ì´ ì—†ìŠµë‹ˆë‹¤';
    $et['ko']['AutoClose'] = 'ì™„ë£Œí›„ ë‹«ê¸°';
    $et['ko']['OutDocRoot'] = 'DOCUMENT_ROOT ì´ë‚´ì˜ íŒŒì¼ì´ ì•„ë‹™ë‹ˆë‹¤';
    $et['ko']['NoCmd'] = 'ì˜¤ë¥˜: ëª…ë ¹ì´ ì‹¤í–‰ë˜ì§€ ì•Šì•˜ìŠµë‹ˆë‹¤';
    $et['ko']['ConfTrySave'] = 'íŒŒì¼ì— ì“°ê¸° ê¶Œí•œì´ ì—†ìŠµë‹ˆë‹¤.\\nê·¸ëž˜ë„ ì €ìž¥í•˜ì‹œê² ìŠµë‹ˆê¹Œ';
    $et['ko']['ConfSaved'] = 'í™˜ê²½ì´ ì €ìž¥ë˜ì—ˆìŠµë‹ˆë‹¤';
    $et['ko']['PassSaved'] = 'ë¹„ë°€ë²ˆí˜¸ ì €ìž¥';
    $et['ko']['FileDirExists'] = 'íŒŒì¼ ë˜ëŠ” ë””ë ‰í† ë¦¬ê°€ ì´ë¯¸ ì¡´ìž¬í•©ë‹ˆë‹¤';
    $et['ko']['NoPhpinfo'] = 'PHPINFO()ë¥¼ ì‚¬ìš©í• ìˆ˜ ì—†ìŠµë‹ˆë‹¤';
    $et['ko']['NoReturn'] = 'ë°˜í™˜ê°’ ì—†ìŒ';
    $et['ko']['FileSent'] = 'íŒŒì¼ ì „ì†¡';
    $et['ko']['SpaceLimReached'] = 'ì €ìž¥ê³µê°€ ì—¬ìœ ê°€ ì—†ìŠµë‹ˆë‹¤';
    $et['ko']['InvExt'] = 'ìœ íš¨í•˜ì§€ ì•Šì€ í™•ìž¥ìž';
    $et['ko']['FileNoOverw'] = 'íŒŒì¼ì„ ë®ì–´ ì“¸ìˆ˜ ì—†ìŠµë‹ˆë‹¤';
    $et['ko']['FileOverw'] = 'íŒŒì¼ì„ ë®ì–´ ì¼ìŠµë‹ˆë‹¤';
    $et['ko']['FileIgnored'] = 'íŒŒì¼ì´ ë¬´ì‹œë˜ì—ˆìŠµë‹ˆë‹¤';
    $et['ko']['ChkVer'] = 'ì—ì„œ ìƒˆë²„ì „ í™•ì¸';
    $et['ko']['ChkVerAvailable'] = 'ìƒˆë¡œìš´ ë²„ì „ì´ ìžˆìŠµë‹ˆë‹¤. ë‹¤ìš´ë°›ìœ¼ë ¤ë©´ í´ë¦­í•˜ì„¸ìš”!!';
    $et['ko']['ChkVerNotAvailable'] = 'ìƒˆë¡œìš´ ë²„ì „ì´ ì—†ìŠµë‹ˆë‹¤. :(';
    $et['ko']['ChkVerError'] = 'ì—°ê²° ì˜¤ë¥˜';
    $et['ko']['Website'] = 'ì›¹ì‚¬ì´íŠ¸';
    $et['ko']['SendingForm'] = 'íŒŒì¼ì„ ì „ì†¡ì¤‘ìž…ë‹ˆë‹¤. ê¸°ë‹¤ë¦¬ì„¸ìš”';
    $et['ko']['NoFileSel'] = 'íŒŒì¼ì´ ì„ íƒë˜ì§€ ì•Šì•˜ìŠµë‹ˆë‹¤';
    $et['ko']['SelAll'] = 'ëª¨ë“ ';
    $et['ko']['SelNone'] = 'ì œë¡œ';
    $et['ko']['SelInverse'] = 'ì—­';
    ...
    $et['de']['Exec'] = 'AusfÃ¼hren';
    $et['de']['Apply'] = 'BestÃ¤tigen';
    ...
    $et['de']['RemSel'] = 'LÃ–SCHE die selektierten Objekte';
    $et['de']['NoDestDir'] = 'Das selektierte Zielverzeichnis existiert nicht';
    $et['de']['DestEqOrig'] = 'Quell- und Zielverzeichnis stimmen Ã¼berein';
    $et['de']['InvalidDest'] = 'Zielverzeichnis ist ungÃ¼ltig';
    $et['de']['NoNewPerm'] = 'Neue Zugriffserlaubnis konnte nicht gesetzt werden';
    $et['de']['CopyTo'] = 'KOPIERE nach';
    $et['de']['MoveTo'] = 'VERSCHIEBE nach';
    $et['de']['AlterPermTo'] = 'Ã„NDERE ZUGRIFFSERLAUBSNIS in';
    $et['de']['ConfExec'] = 'BestÃ¤tige AUSFÃœHRUNG';
    $et['de']['ConfRem'] = 'BestÃ¤tige LÃ–SCHEN';
    ...
    $et['de']['InvPass'] = 'UngÃ¼ltiges Passwort';
    $et['de']['ReadDenied'] = 'Lesezugriff verweigert';
    $et['de']['FileNotFound'] = 'Datei nicht gefunden';
    $et['de']['AutoClose'] = 'SchlieÃŸen, wenn fertig';
    $et['de']['OutDocRoot'] = 'Datei auÃŸerhalb von DOCUMENT_ROOT';
    $et['de']['NoCmd'] = 'Fehler: Es wurde kein Kommando eingetragen';
    $et['de']['ConfTrySave'] = 'Keine Schreibberechtigung fÃ¼r die Datei.\\nVersuche trotzdem zu speichern';
    ...
    $et['de']['NoReturn'] = 'keine RÃ¼ckgabe';
    $et['de']['FileSent'] = 'Datei wurde gesendet';
    $et['de']['SpaceLimReached'] = 'VerfÃ¼gbares Speicherlimit wurde erreicht';
    $et['de']['InvExt'] = 'UngÃ¼ltige Dateiendung';
    $et['de']['FileNoOverw'] = 'Datei kann nicht Ã¼berschrieben werden';
    $et['de']['FileOverw'] = 'Datei Ã¼berschrieben';
    $et['de']['FileIgnored'] = 'Datei ignoriert';
    $et['de']['ChkVer'] = 'PrÃ¼fe auf neue Version';
    $et['de']['ChkVerAvailable'] = 'Neue Version verfÃ¼gbar; klicke hier, um den Download zu starten!!';
    ...
    $et['de2']['NoSel'] = 'Keine EintrÃ¤ge ausgewÃ¤hlt';
    $et['de2']['SelDir'] = 'WÃ¤hlen Sie das Zeilverzeichnis im Verzeichnis links';
    ...
    $et['de2']['InvPass'] = 'UngÃ¼ltiges Passwort';
    ...
    $et['de2']['NoReturn'] = 'keine RÃ¼ckgabe';
    $et['de2']['FileSent'] = 'Datei versandt';
    $et['de2']['SpaceLimReached'] = 'Plattenplatz erschÃ¶pft';
    $et['de2']['InvExt'] = 'UngÃ¼ltige datei-Extension';
    $et['de2']['FileNoOverw'] = 'Datei kann nicht Ã¼berschrieben werden';
    $et['de2']['FileOverw'] = 'Datei Ã¼berschrieben';
    $et['de2']['FileIgnored'] = 'Datei ignoriert';
    $et['de2']['ChkVer'] = 'ÃœberprÃ¼fe neuer Version';
    $et['de2']['ChkVerAvailable'] = 'Neue Version. Hier klicken fÃ¼r Download!!';
    $et['de2']['ChkVerNotAvailable'] = 'Keine neue Version verfÃ¼gbar. :(';
    $et['de2']['ChkVerError'] = 'Verbindungsfehler.';
    $et['de2']['Website'] = 'Webseite';
    $et['de2']['SendingForm'] = 'Sende Dateien, bitte warten';
    $et['de2']['NoFileSel'] = 'Keine Dateien ausgewÃ¤hlt';
    $et['de2']['SelAll'] = 'Alle';
    $et['de2']['SelNone'] = 'Keine';
    $et['de2']['SelInverse'] = 'Invers';
    $et['de2']['Selected_s'] = 'ausgewÃ¤hlt';
    $et['de2']['Total'] = 'Total';
    ...
    $et['fr']['Move'] = 'DÃ©placer';
    $et['fr']['Copy'] = 'Copier';
    $et['fr']['ServerInfo'] = 'info du sreveur';
    $et['fr']['CreateDir'] = 'CrÃ©er un rÃ©pertoire';
    $et['fr']['CreateArq'] = 'CrÃ©er un fichier';
    $et['fr']['ExecCmd'] = 'Executer une Commande';
    $et['fr']['Upload'] = 'TÃ©lÃ©versement(upload)';
    $et['fr']['UploadEnd'] = 'TÃ©lÃ©versement Fini';
    $et['fr']['Perm'] = 'Perm';
    $et['fr']['Perms'] = 'Permissions';
    $et['fr']['Owner'] = 'PropriÃ©taire';
    $et['fr']['Group'] = 'Groupe';
    $et['fr']['Other'] = 'Autre';
    $et['fr']['Size'] = 'Taille';
    $et['fr']['Date'] = 'Date';
    ...
    $et['fr']['Dir_s'] = 'rÃ©pertoire(s)';
    $et['fr']['To'] = 'Ã ';
    $et['fr']['Destination'] = 'Destination';
    $et['fr']['Configurations'] = 'Configurations';
    $et['fr']['JSError'] = 'Erreur JavaScript';
    $et['fr']['NoSel'] = 'Rien n\'est sÃ©lectionnÃ©';
    $et['fr']['SelDir'] = 'Selectionnez le rÃ©pertoire de destination dans le panneau gauche';
    $et['fr']['TypeDir'] = 'Entrer le nom du rÃ©pertoire';
    $et['fr']['TypeArq'] = 'Entrer le nom du fichier';
    $et['fr']['TypeCmd'] = 'Entrer la commande';
    $et['fr']['TypeArqComp'] = 'Entrer le nom du fichier.\\nL\'extension dÃ©finira le type de compression.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $et['fr']['RemSel'] = 'EFFACER les objets sÃ©lectionnÃ©s';
    $et['fr']['NoDestDir'] = 'Aucun rÃ©pertoire de destination n\'est sÃ©lectionnÃ©';
    $et['fr']['DestEqOrig'] = 'Les rÃ©pertoires source et destination sont identiques';
    $et['fr']['InvalidDest'] = 'Le rÃ©pertoire de destination est invalide';
    $et['fr']['NoNewPerm'] = 'Nouvelle permission non Ã©tablie';
    ...
    $et['fr']['EmptyDir'] = 'RÃ©pertoire vide';
    ...
    $et['fr']['ReadDenied'] = 'Droit de lecture refusÃ©';
    $et['fr']['FileNotFound'] = 'Fichier introuvable';
    $et['fr']['AutoClose'] = 'Fermer sur fin';
    $et['fr']['OutDocRoot'] = 'Fichier au delÃ  de DOCUMENT_ROOT';
    $et['fr']['NoCmd'] = 'Erreur: Commande non renseignÃ©e';
    $et['fr']['ConfTrySave'] = 'Fichier sans permission d\'Ã©criture.\\nJ\'essaie de l\'enregister';
    $et['fr']['ConfSaved'] = 'Configurations enreristrÃ©e';
    $et['fr']['PassSaved'] = 'Mot de passe enreristrÃ©';
    $et['fr']['FileDirExists'] = 'Le fichier ou le rÃ©pertoire existe dÃ©jÃ ';
    $et['fr']['NoPhpinfo'] = 'Function phpinfo dÃ©sactivÃ©e';
    $et['fr']['NoReturn'] = 'pas de retour';
    $et['fr']['FileSent'] = 'Fichier envoyÃ©';
    $et['fr']['SpaceLimReached'] = 'Espace maxi atteint';
    $et['fr']['InvExt'] = 'Extension invalide';
    $et['fr']['FileNoOverw'] = 'Le fichier ne peut pas etre Ã©crasÃ©';
    $et['fr']['FileOverw'] = 'Fichier Ã©crasÃ©';
    $et['fr']['FileIgnored'] = 'Fichier ignorÃ©';
    $et['fr']['ChkVer'] = 'Verifier nouvelle version';
    $et['fr']['ChkVerAvailable'] = 'Nouvelle version, cliquer ici pour la tÃ©lÃ©chager!!';
    ...
    $et['fr']['NoFileSel'] = 'Aucun fichier sÃ©lectionnÃ©';
    $et['fr']['SelAll'] = 'Tous';
    $et['fr']['SelNone'] = 'Aucun';
    $et['fr']['SelInverse'] = 'Inverser';
    $et['fr']['Selected_s'] = 'selectionÃ©';
    $et['fr']['Total'] = 'total';
    ...
    $et['fr2']['Decompress'] = 'DÃ©compresser';
    $et['fr2']['ResolveIDs'] = 'RÃ©soudre ID';
    $et['fr2']['Move'] = 'DÃ©placer';
    $et['fr2']['Copy'] = 'Copier';
    $et['fr2']['ServerInfo'] = 'Information Serveur';
    $et['fr2']['CreateDir'] = 'CrÃ©er un rÃ©pertoire';
    $et['fr2']['CreateArq'] = 'CrÃ©er un fichier';
    $et['fr2']['ExecCmd'] = 'ExecutÃ© une commande';
    $et['fr2']['Upload'] = 'TransfÃ©rer';
    $et['fr2']['UploadEnd'] = 'Transfert terminÃ©';
    $et['fr2']['Perm'] = 'Perm';
    $et['fr2']['Perms'] = 'Permissions';
    $et['fr2']['Owner'] = 'PropriÃ©taire';
    $et['fr2']['Group'] = 'Groupe';
    $et['fr2']['Other'] = 'Autre';
    $et['fr2']['Size'] = 'Taille';
    $et['fr2']['Date'] = 'date';
    ...
    $et['fr2']['Dir_s'] = 'rÃ©pertoire(s)';
    $et['fr2']['To'] = 'Ã ';
    $et['fr2']['Destination'] = 'Destination';
    $et['fr2']['Configurations'] = 'Configurations';
    $et['fr2']['JSError'] = 'Erreur JavaScript';
    $et['fr2']['NoSel'] = 'Il n\'y a pas d\'objets sÃ©lectionnÃ©s';
    $et['fr2']['SelDir'] = 'SÃ©lectionnez le rÃ©pertoire de destination sur l\'arborescence de gauche';
    $et['fr2']['TypeDir'] = 'Entrez le nom du rÃ©pertoire';
    $et['fr2']['TypeArq'] = 'Entrez le nom du fichier';
    $et['fr2']['TypeCmd'] = 'Entrez la commande';
    $et['fr2']['TypeArqComp'] = 'Entrez le fichier.\\nL\'extension dÃ©finira le type de compression.\\nEx:\\nnom.zip\\nnom.tar\\nnom.bzip\\nnom.gzip';
    $et['fr2']['RemSel'] = 'EFFACEZ l\'objet sÃ©lectionnÃ©';
    $et['fr2']['NoDestDir'] = 'Il n\'y a aucun rÃ©pertoire de destination sÃ©lectionnÃ©';
    $et['fr2']['DestEqOrig'] = 'Origine et rÃ©pertoires de destination sont identique';
    $et['fr2']['InvalidDest'] = 'RÃ©pertoire de destination est invalide';
    $et['fr2']['NoNewPerm'] = 'Nouvelle autorisation n\'a pas Ã©tÃ© configurÃ©';
    $et['fr2']['CopyTo'] = 'COPIE dans';
    $et['fr2']['MoveTo'] = 'DÃ‰PLACER dans';
    $et['fr2']['AlterPermTo'] = 'CHANGER PERMISSIONS dans';
    $et['fr2']['ConfExec'] = 'Confirmer EXECUTE';
    $et['fr2']['ConfRem'] = 'Confirmer EFFACER';
    $et['fr2']['EmptyDir'] = 'RÃ©pertoire vide';
    ...
    $et['fr2']['ReadDenied'] = 'AccÃ¨s en lecture refuser';
    $et['fr2']['FileNotFound'] = 'Fichier non-trouvÃ©';
    $et['fr2']['AutoClose'] = 'Fermez a la fin';
    $et['fr2']['OutDocRoot'] = 'Fichier au-delÃ  DOCUMENT_ROOT';
    $et['fr2']['NoCmd'] = 'Erreur: Commande inconnue';
    $et['fr2']['ConfTrySave'] = 'Fichier sans permission d\'Ã©criture.\\nEssayez de sauver';
    $et['fr2']['ConfSaved'] = 'Configurations sauvÃ©e';
    $et['fr2']['PassSaved'] = 'Mot de passe sauvÃ©';
    $et['fr2']['FileDirExists'] = 'Fichier ou rÃ©pertoire dÃ©jÃ  existant';
    $et['fr2']['NoPhpinfo'] = 'Function phpinfo dÃ©sactivÃ©';
    $et['fr2']['NoReturn'] = 'sans retour possible';
    $et['fr2']['FileSent'] = 'Fichier envoyÃ©';
    $et['fr2']['SpaceLimReached'] = 'Limite de d\'espace atteint';
    $et['fr2']['InvExt'] = 'Extension invalide';
    $et['fr2']['FileNoOverw'] = 'Fichier ne peut pas Ãªtre Ã©crasÃ©';
    $et['fr2']['FileOverw'] = 'Fichier Ã©crasÃ©';
    $et['fr2']['FileIgnored'] = 'Fichier ignorÃ©';
    $et['fr2']['ChkVer'] = 'Check nouvelle version';
    $et['fr2']['ChkVerAvailable'] = 'Nouvelle version, cliquez ici pour commencer le tÃ©lÃ©chargement!!';
    ...
    $et['fr2']['SendingForm'] = 'Envoye de fichier, s\'il vous plaÃ®t patientez';
    $et['fr2']['NoFileSel'] = 'Aucun fichier sÃ©lectionnÃ©';
    $et['fr2']['SelAll'] = 'Tout';
    $et['fr2']['SelNone'] = 'Aucuns';
    $et['fr2']['SelInverse'] = 'Inverser';
    $et['fr2']['Selected_s'] = 'sÃ©lectionnÃ©';
    $et['fr2']['Total'] = 'total';
    ...
    $et['fr3']['Dir_s'] = 'rÃ©pertoire(s)';
    $et['fr3']['To'] = 'Ã ';
    $et['fr3']['Destination'] = 'Destination';
    $et['fr3']['Configurations'] = 'Configurations';
    $et['fr3']['JSError'] = 'Erreur JavaScript';
    $et['fr3']['NoSel'] = 'Aucun Ã©lÃ©ment sÃ©lectionnÃ©';
    $et['fr3']['SelDir'] = "SÃ©lectionner le rÃ©pertoire de destination dans l'arboresence de gauchethe destination directory on the left tree";
    $et['fr3']['TypeDir'] = 'Indiquer le nom du rÃ©pertoire';
    $et['fr3']['TypeArq'] = 'Indiquer le nom du fichier';
    $et['fr3']['TypeCmd'] = 'Entrer une commande';
    $et['fr3']['TypeArqComp'] = "Indiquer le nom du fichier.\\nL'extension dÃ©finira le type de compression.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip";
    $et['fr3']['RemSel'] = "SUPPRIMER l'Ã©lÃ©ment sÃ©lectionnÃ©";
    $et['fr3']['NoDestDir'] = "Il n'y a pas de rÃ©pertoire destination sÃ©lectionnÃ©";
    $et['fr3']['DestEqOrig'] = 'RÃ©pertoire Origine et Destination sont identiques';
    $et['fr3']['InvalidDest'] = 'Le rÃ©pertoire de destination est invalide';
    $et['fr3']['NoNewPerm'] = 'Nouvelle permission non appliquÃ©e';
    ...
    $et['fr3']['EmptyDir'] = 'RÃ©pertoire vide';
    $et['fr3']['IOError'] = 'Erreur entrÃ©e/sortie';
    $et['fr3']['FileMan'] = 'PHP File Manager';
    $et['fr3']['TypePass'] = 'Saisir le mot de passe';
    $et['fr3']['InvPass'] = 'Mot de passe invalide';
    $et['fr3']['ReadDenied'] = 'AccÃ¨s en lecture refusÃ©';
    $et['fr3']['FileNotFound'] = 'Fichier non trouvÃ©';
    $et['fr3']['AutoClose'] = 'Fermeture en fin de traitement';
    $et['fr3']['OutDocRoot'] = 'Fichier en dessous de DOCUMENT_ROOT';
    $et['fr3']['NoCmd'] = 'Erreur : Commande non renseignÃ©e';
    $et['fr3']['ConfTrySave'] = "Fichier sans permission d'Ã©criture.\\nTenter de sauver malgrÃ© tout";
    $et['fr3']['ConfSaved'] = 'Configurations sauvegardÃ©e';
    $et['fr3']['PassSaved'] = 'Password sauvegardÃ©';
    $et['fr3']['FileDirExists'] = 'Fichier ou rÃ©pertoire dÃ©jÃ  existant';
    $et['fr3']['NoPhpinfo'] = 'Fonction phpinfo disactivÃ©e';
    $et['fr3']['NoReturn'] = 'pas de retour';
    $et['fr3']['FileSent'] = 'Fichier envoyÃ©';
    $et['fr3']['SpaceLimReached'] = 'CapacitÃ© maximale atteinte';
    $et['fr3']['InvExt'] = 'Extension invalide';
    $et['fr3']['FileNoOverw'] = 'Fichier ne pouvant Ãªtre remplacÃ©';
    $et['fr3']['FileOverw'] = 'Fichier remplacÃ©';
    $et['fr3']['FileIgnored'] = 'Fichier ignorÃ©';
    $et['fr3']['ChkVer'] = 'VÃ©rifier nouvelle version';
    $et['fr3']['ChkVerAvailable'] = 'Nouvelle version, cliquer ici pour commencer le tÃ©lÃ©chargement !';
    ...
    $et['fr3']['NoFileSel'] = 'Pas de fichier sÃ©lectionnÃ©';
    $et['fr3']['SelAll'] = 'Tous';
    $et['fr3']['SelNone'] = 'Aucun';
    $et['fr3']['SelInverse'] = 'Inverser';
    $et['fr3']['Selected_s'] = 'sÃ©lectionnÃ©';
    $et['fr3']['Total'] = 'total';
    $et['fr3']['Partition'] = 'Partition';
    $et['fr3']['RenderTime'] = 'Temps nÃ©cessaire pour obtenir cette page';
    $et['fr3']['Seconds'] = 'sec';
    ...
    $et['it']['TypeArqComp'] = 'Inserisci il nome del file.\\nLa estensione definirÃ  il tipo di compressione.\\nEsempio:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $et['it']['RemSel'] = 'ELIMINA gli elementi selezionati';
    $et['it']['NoDestDir'] = 'LA directory di destinazione non Ã¨ stata selezionata';
    $et['it']['DestEqOrig'] = 'La directory di origine e di destinazione sono la stessa';
    $et['it']['InvalidDest'] = 'La directory di destinazione non Ã¨ valida';
    ...
    $et['it']['FileDirExists'] = 'Il file o la directory esiste giÃ ';
    $et['it']['NoPhpinfo'] = 'La funzione phpinfo Ã¨ disabilitata';
    $et['it']['NoReturn'] = 'senza Return';
    $et['it']['FileSent'] = 'File inviato';
    $et['it']['SpaceLimReached'] = 'Ã¨ stato raggiunto il limite di spazio disponibile';
    $et['it']['InvExt'] = 'Estensione non valida';
    $et['it']['FileNoOverw'] = 'Il file non puÃ² essere sovrascritto';
    $et['it']['FileOverw'] = 'File sovrascritto';
    $et['it']['FileIgnored'] = 'File ignorato';
    $et['it']['ChkVer'] = 'Controlla se Ã¨ disponibile una nuova versione';
    $et['it']['ChkVerAvailable'] = 'Ã¨ disponibile una nuova versione: premi qui per scaricarla.';
    $et['it']['ChkVerNotAvailable'] = 'Non Ã¨ disponibile nessuna nuova versione. :(';
    ...
    $et['it2']['TypeArqComp'] = 'Inserisci il nome del file.\\nL\'estensione definirÃ  le modalitÃ  di compressione.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $et['it2']['RemSel'] = 'ELIMINA gli item selezionati';
    $et['it2']['NoDestDir'] = 'Non Ã¨ stata selezionata la cartella di destinazione';
    $et['it2']['DestEqOrig'] = 'La cartella di origine e di destinazione coincidono';
    $et['it2']['InvalidDest'] = 'La cartella di destinazione non Ã¨ valida';
    ...
    $et['it2']['FileDirExists'] = 'Il file o la cartella esiste giÃ ';
    ...
    $et['it4']['FileDirExists'] = 'Il file o la directory esistono giÃ ';
    ...
    $et['it4']['FileNoOverw'] = 'Il file non puÃ² essere sovrascritto';
    ...
    // Ð Ð¾ÑÑÐ¸Ñ - Ð•Ð²Ð³ÐµÐ½Ð¸Ð¹ Ð Ð°ÑˆÐµÐ²
    $et['ru']['Version']='Ð’ÐµÑ€ÑÐ¸Ñ';
    $et['ru']['DocRoot']='Ð”Ð¾ÐºÑƒÐ¼ÐµÐ½Ñ‚ Root ';
    $et['ru']['FLRoot']='Ð¤Ð°Ð¹Ð»Ð¾Ð²Ñ‹Ð¹ Ð¼ÐµÐ½ÐµÐ´Ð¶ÐµÑ€';
    $et['ru']['Name']='Ð˜Ð¼Ñ';
    $et['ru']['And']='Ð¸';
    $et['ru']['Enter']='Enter';
    $et['ru']['Send']='ÐžÑ‚Ð¿Ñ€Ð°Ð²Ð¸Ñ‚ÑŒ';
    $et['ru']['Refresh']='ÐžÐ±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ';
    $et['ru']['SaveConfig']='Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ ÐºÐ¾Ð½Ñ„Ð¸Ð³ÑƒÑ€Ð°Ñ†Ð¸ÑŽ';
    $et['ru']['SavePass']='Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ';
    $et['ru']['SaveFile']='Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ Ñ„Ð°Ð¹Ð» ';
    $et['ru']['Save']='Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ';
    $et['ru']['Leave']='ÐžÑÑ‚Ð°Ð²ÑŒ';
    $et['ru']['Edit']='Ð˜Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ';
    $et['ru']['View']='ÐŸÑ€Ð¾ÑÐ¼Ð¾Ñ‚Ñ€';
    $et['ru']['Config']='ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸';
    $et['ru']['Ren']='ÐŸÐµÑ€ÐµÐ¸Ð¼ÐµÐ½Ð¾Ð²Ð°Ñ‚ÑŒ';
    $et['ru']['Rem']='Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ';
    $et['ru']['Compress']='Ð¡Ð¶Ð°Ñ‚ÑŒ';
    $et['ru']['Decompress']='Ð Ð°ÑÐ¿Ð°ÐºÐ¾Ð²Ð°Ñ‚ÑŒ';
    $et['ru']['ResolveIDs']='ÐžÐ¿Ñ€ÐµÐ´ÐµÐ»ÑÑ‚ÑŒ id';
    $et['ru']['Move']='ÐŸÐµÑ€ÐµÐ¼ÐµÑÑ‚Ð¸Ñ‚ÑŒ';
    $et['ru']['Copy']='ÐšÐ¾Ð¿Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ';
    $et['ru']['ServerInfo']='Ð˜Ð½Ñ„Ð¾ Ð¾ ÑÐµÑ€Ð²ÐµÑ€Ðµ';
    $et['ru']['CreateDir']='Ð¡Ð¾Ð·Ð´Ð°Ñ‚ÑŒ Ð¿Ð°Ð¿ÐºÑƒ';
    $et['ru']['CreateArq']='Ð¡Ð¾Ð·Ð´Ð°Ð¹Ñ‚Ðµ Ñ„Ð°Ð¹Ð» ';
    $et['ru']['ExecCmd']='Ð’Ñ‹Ð¿Ð¾Ð»Ð½Ð¸Ñ‚ÑŒ';
    $et['ru']['Upload']='Ð—Ð°Ð³Ñ€ÑƒÐ·Ð¸Ñ‚ÑŒ';
    $et['ru']['UploadEnd']='Ð—Ð°Ð³Ñ€ÑƒÐ¶ÐµÐ½Ð¾';
    $et['ru']['Perm']='ÐŸÑ€Ð°Ð²Ð°';
    $et['ru']['Perms']='Ð Ð°Ð·Ñ€ÐµÑˆÐµÐ½Ð¸Ñ';
    $et['ru']['Owner']='Ð’Ð»Ð°Ð´ÐµÐ»ÐµÑ†';
    $et['ru']['Group']='Ð“Ñ€ÑƒÐ¿Ð¿Ð°';
    $et['ru']['Other']='Ð”Ñ€ÑƒÐ³Ð¸Ðµ';
    $et['ru']['Size']='Ð Ð°Ð·Ð¼ÐµÑ€';
    $et['ru']['Date']='Ð”Ð°Ñ‚Ð°';
    $et['ru']['Type']='Ð¢Ð¸Ð¿';
    $et['ru']['Free']='Ð¡Ð²Ð¾Ð±Ð¾Ð´Ð½Ð¾';
    $et['ru']['Shell']='Shell';
    $et['ru']['Read']='Ð§Ð¸Ñ‚Ð°Ñ‚ÑŒ';
    $et['ru']['Write']='ÐŸÐ¸ÑÐ°Ñ‚ÑŒ';
    $et['ru']['Exec']='Ð’Ñ‹Ð¿Ð¾Ð»Ð½ÑÑ‚ÑŒ';
    $et['ru']['Apply']='ÐŸÑ€Ð¸Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ';
    $et['ru']['StickyBit']='StickyBit';
    $et['ru']['Pass']='ÐŸÐ°Ñ€Ð¾Ð»ÑŒ';
    $et['ru']['Lang']='Ð¯Ð·Ñ‹Ðº';
    $et['ru']['File']='Ð¤Ð°Ð¹Ð»';
    $et['ru']['File_s']='Ð¤Ð°Ð¹Ð»..';
    $et['ru']['Dir_s']='ÐŸÐ°Ð¿..';
    $et['ru']['To']='Ð²';
    $et['ru']['Destination']='ÐÐ°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ðµ';
    $et['ru']['Configurations']='ÐšÐ¾Ð½Ñ„Ð¸Ð³ÑƒÑ€Ð°Ñ†Ð¸Ñ';
    $et['ru']['JSError']='ÐžÑˆÐ¸Ð±ÐºÐ° JavaScript';
    $et['ru']['NoSel']='Ð½ÐµÑ‚ Ð²Ñ‹Ð±Ñ€Ð°Ð½Ð½Ñ‹Ñ… ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚Ð¾Ð²';
    $et['ru']['SelDir']='Ð’Ñ‹Ð±ÐµÑ€Ð¸Ñ‚Ðµ Ð¿Ð°Ð¿ÐºÑƒ Ð½Ð°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ñ Ð½Ð° Ð»ÐµÐ²Ð¾Ð¼ Ð´ÐµÑ€ÐµÐ²Ðµ ';
    $et['ru']['TypeDir']='Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð¸Ð¼Ñ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³Ð° ';
    $et['ru']['TypeArq']='Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð¸Ð¼Ñ Ñ„Ð°Ð¹Ð»Ð°';
    $et['ru']['TypeCmd']='Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ ÐºÐ¾Ð¼Ð°Ð½Ð´Ñƒ ';
    $et['ru']['TypeArqComp']='Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð¸Ð¼Ñ Ñ„Ð°Ð¹Ð»Ð° ,Ñ€Ð°ÑÑˆÐ¸Ñ€ÐµÐ½Ð¸Ðµ\\n ÑÑ‚Ð¾ Ð¿Ð¾Ð·Ð²Ð¾Ð»Ð¸Ñ‚ Ð¾Ð¿Ñ€ÐµÐ´ÐµÐ»Ð¸Ñ‚ÑŒ Ñ‚Ð¸Ð¿ ÑÐ¶Ð°Ñ‚Ð¸Ñ \\n ÐŸÑ€Ð¸Ð¼ÐµÑ€:.. \\n nome.zip \\n nome.tar \\n nome.bzip \\n nome.gzip ';
    $et['ru']['RemSel']='Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ Ð²Ñ‹Ð±Ñ€Ð°Ð½Ð½Ñ‹Ðµ ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚Ñ‹';
    $et['ru']['NoDestDir']='Ð½ÐµÑ‚ Ð²Ñ‹Ð±Ñ€Ð°Ð½Ð½Ð¾Ð³Ð¾ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³Ð° Ð½Ð°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ñ';
    $et['ru']['DestEqOrig']='ÐŸÑ€Ð¾Ð¸ÑÑ…Ð¾Ð¶Ð´ÐµÐ½Ð¸Ðµ Ð¸ Ð½Ð°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ðµ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³Ð¾Ð² Ñ€Ð°Ð²Ð½Ñ‹ ';
    $et['ru']['InvalidDest']='ÐÐ°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ðµ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³Ð° Ð½ÐµÐ´ÐµÐ¹ÑÑ‚Ð²Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ð¾';
    $et['ru']['NoNewPerm']='ÐÐ¾Ð²Ñ‹Ðµ Ñ€Ð°Ð·Ñ€ÐµÑˆÐµÐ½Ð¸Ñ Ð½Ðµ ÑƒÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½Ñ‹';
    $et['ru']['CopyTo']='ÐšÐ¾Ð¿Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ð² ';
    $et['ru']['MoveTo']='ÐŸÐµÑ€ÐµÐ¼ÐµÑÑ‚Ð¸Ñ‚ÑŒ Ð²';
    $et['ru']['AlterPermTo']='Ð˜Ð·Ð¼ÐµÐ½ÐµÐ½Ð¸Ðµ Ñ€Ð°Ð·Ñ€ÐµÑˆÐµÐ½Ð¸Ð¹ Ð² ';
    $et['ru']['ConfExec']='ÐŸÐ¾Ð´Ñ‚Ð²ÐµÑ€Ð´Ð¸Ñ‚ÑŒ Ð’Ð«ÐŸÐžÐ›ÐÐ˜Ð¢Ð¬ ';
    $et['ru']['ConfRem']='ÐŸÐ¾Ð´Ñ‚Ð²ÐµÑ€Ð´Ð¸Ñ‚ÑŒ Ð£Ð”ÐÐ›Ð•ÐÐ˜Ð•';
    $et['ru']['EmptyDir']='ÐŸÑƒÑÑ‚Ð¾Ð¹ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³ ';
    $et['ru']['IOError']='I/O Error';
    $et['ru']['FileMan']='PHP Ð¤Ð°Ð¹Ð»Ð¾Ð²Ñ‹Ð¹ Ð¼ÐµÐ½ÐµÐ´Ð¶ÐµÑ€ ';
    $et['ru']['TypePass']='Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ';
    $et['ru']['InvPass']='ÐÐµÐ²ÐµÑ€Ð½Ñ‹Ð¹ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ';
    $et['ru']['ReadDenied']='Ð”Ð¾ÑÑ‚ÑƒÐ¿ Ð·Ð°Ð¿Ñ€ÐµÑ‰ÐµÐ½ ';
    $et['ru']['FileNotFound']='Ð¤Ð°Ð¹Ð» Ð½Ðµ Ð½Ð°Ð¹Ð´ÐµÐ½';
    $et['ru']['AutoClose']='Ð—Ð°ÐºÑ€Ñ‹Ñ‚ÑŒ Ð¿Ð¾Ð»Ð½Ð¾ÑÑ‚ÑŒÑŽ ';
    $et['ru']['OutDocRoot']='Ð¤Ð°Ð¹Ð»Ñ‹ Ð·Ð° Ð¿Ñ€ÐµÐ´ÐµÐ»Ð°Ð¼Ð¸ DOCUMENT_ROOT';
    $et['ru']['NoCmd']='ÐžÑˆÐ¸Ð±ÐºÐ°: ÐÐµ Ð¿Ð¾Ð´Ð´ÐµÑ€Ð¶Ð¸Ð²Ð°ÐµÐ¼Ð°Ñ ÐºÐ¾Ð¼Ð°Ð½Ð´Ð°';
    $et['ru']['ConfTrySave']='Ð¤Ð°Ð¹Ð» Ð±ÐµÐ· Ð¿Ñ€Ð°Ð² Ð½Ð° Ð·Ð°Ð¿Ð¸ÑÑŒ. \\n Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ Ð² Ð»ÑŽÐ±Ð¾Ð¼ ÑÐ»ÑƒÑ‡Ð°Ðµ. ';
    $et['ru']['ConfSaved']='ÐšÐ¾Ð½Ñ„Ð¸Ð³ÑƒÑ€Ð°Ñ†Ð¸Ñ ÑÐ¾Ñ…Ñ€Ð°Ð½ÐµÐ½Ð°';
    $et['ru']['PassSaved']='ÐŸÐ°Ñ€Ð¾Ð»ÑŒ ÑÐ¾Ñ…Ñ€Ð°Ð½ÐµÐ½';
    $et['ru']['FileDirExists']='Ð¤Ð°Ð¹Ð» Ð¸Ð»Ð¸ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³ ÑƒÐ¶Ðµ ÑÑƒÑ‰ÐµÑÑ‚Ð²ÑƒÐµÑ‚';
    $et['ru']['NoPhpinfo']='Ð¤ÑƒÐ½ÐºÑ†Ð¸Ñ PHPInfo Ð¾Ñ‚ÐºÐ»ÑŽÑ‡ÐµÐ½Ð°';
    $et['ru']['NoReturn']='ÐÐµÑ‚ Ð²Ð¾Ð·Ð²Ñ€Ð°Ñ‚Ð°';
    $et['ru']['FileSent']='Ð¤Ð°Ð¹Ð» Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½';
    $et['ru']['SpaceLimReached']='Ð”Ð¾ÑÑ‚Ð¸Ð³Ð½ÑƒÑ‚ Ð¿Ñ€ÐµÐ´ÐµÐ» ÐŸÑ€Ð¾ÑÑ‚Ñ€Ð°Ð½ÑÑ‚Ð²Ð°';
    $et['ru']['InvExt']='ÐÐµÐ²ÐµÑ€Ð½Ð¾Ðµ Ñ€Ð°ÑÑˆÐ¸Ñ€ÐµÐ½Ð¸Ðµ';
    $et['ru']['FileNoOverw']='Ð¤Ð°Ð¹Ð» Ð½Ðµ Ð¼Ð¾Ð¶ÐµÑ‚ Ð±Ñ‹Ñ‚ÑŒ Ð¿ÐµÑ€ÐµÐ·Ð°Ð¿Ð¸ÑÐ°Ð½ ';
    $et['ru']['FileOverw']='Ð¤Ð°Ð¹Ð» Ð¿ÐµÑ€ÐµÐ·Ð°Ð¿Ð¸ÑÑ‹Ð²Ð°ÐµÑ‚ÑÑ';
    $et['ru']['FileIgnored']='Ð¤Ð°Ð¹Ð» Ð¸Ð³Ð½Ð¾Ñ€Ð¸Ñ€ÑƒÐµÑ‚ÑÑ';
    $et['ru']['ChkVer']='ÐŸÑ€Ð¾Ð²ÐµÑ€Ð¸Ñ‚ÑŒ Ð¾Ð±Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ðµ';
    $et['ru']['ChkVerAvailable']=' Ð”Ð¾ÑÑ‚ÑƒÐ¿Ð½Ð° Ð½Ð¾Ð²Ð°Ñ Ð²ÐµÑ€ÑÐ¸Ñ, Ð½Ð°Ð¶Ð¼Ð¸Ñ‚Ðµ Ð·Ð´ÐµÑÑŒ, Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð½Ð°Ñ‡Ð°Ñ‚ÑŒ Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÑƒ! ';
    $et['ru']['ChkVerNotAvailable']='ÐÐµÑ‚ Ð½Ð¾Ð²Ð¾Ð¹ Ð²ÐµÑ€ÑÐ¸Ð¸. :(';
    $et['ru']['ChkVerError']='ÐžÑˆÐ¸Ð±ÐºÐ° Ð¿Ð¾Ð´ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¸Ñ. ';
    $et['ru']['Website']='Ð¡Ð°Ð¹Ñ‚';
    $et['ru']['SendingForm']='ÐžÑ‚Ð¿Ñ€Ð°Ð²ÐºÐ° Ñ„Ð°Ð¹Ð»Ð¾Ð², Ð¿Ð¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð°, Ð¿Ð¾Ð´Ð¾Ð¶Ð´Ð¸Ñ‚Ðµ ';
    $et['ru']['NoFileSel']='ÐÐµÑ‚ Ð²Ñ‹Ð±Ñ€Ð°Ð½Ð½Ñ‹Ñ… Ñ„Ð°Ð¹Ð»Ð¾Ð²';
    $et['ru']['SelAll']='Ð’Ñ‹Ð´ÐµÐ»Ð¸Ñ‚ÑŒ Ð²ÑÐµ';
    $et['ru']['SelNone']='ÐžÑ‚Ð¼ÐµÐ½Ð°';
    $et['ru']['SelInverse']='ÐžÐ±Ñ€Ð°Ñ‚Ð¸Ñ‚ÑŒ';
    $et['ru']['Selected_s']='Ð’Ñ‹Ð±Ñ€Ð°Ð½';
    $et['ru']['Total']='Ð’ÑÐµÐ³Ð¾';
    $et['ru']['Partition']='Ð Ð°Ð·Ð´ÐµÐ»';
    $et['ru']['RenderTime']='Ð¡ÐºÑ€Ð¸Ð¿Ñ‚ Ð²Ñ‹Ð¿Ð¾Ð»Ð½ÐµÐ½ Ð·Ð°';
    $et['ru']['Seconds']='Ð¡ÐµÐºÑƒÐ½Ð´';
    $et['ru']['ErrorReport']='ÐžÑ‚Ñ‡ÐµÑ‚ Ð¾Ð± Ð¾ÑˆÐ¸Ð±ÐºÐ°Ñ…';

    // Catalan - by Pere BorrÃ s AKA @Norl
    $et['ca']['Version'] = 'VersiÃ³';
    ...
    $et['ca']['Upload'] = 'Pujar';
    $et['ca']['UploadEnd'] = 'Pujat amb Ã¨xit';
    $et['ca']['Perm'] = 'Perm';
    ...
    $et['ca']['ConfExec'] = 'Confirmar EXECUCIÃ“';
    ...
    $et['ca']['InvPass'] = 'Clau invÃ lida';
    $et['ca']['ReadDenied'] = 'AccÃ©s de lectura denegat';
    ...
    $et['ca']['ConfSaved'] = 'ConfiguraciÃ³ Desada';
    $et['ca']['PassSaved'] = 'Clau desada';
    $et['ca']['FileDirExists'] = 'Arxiu o directori ja existent';
    $et['ca']['NoPhpinfo'] = 'FunciÃ³ phpinfo() no habilitada';
    $et['ca']['NoReturn'] = 'sense retorn';
    $et['ca']['FileSent'] = 'Arxiu enviat';
    $et['ca']['SpaceLimReached'] = 'LÃ­mit d`espaci al disc assolit';
    $et['ca']['InvExt'] = 'ExtensiÃ³ no vÃ lida';
    ...
    $et['ca']['ChkVerAvailable'] = 'Nova versiÃ³, feu clic aquÃ­ per descarregar';
    $et['ca']['ChkVerNotAvailable'] = 'La vostra versiÃ³ Ã©s la mÃ©s recent.';
    $et['ca']['ChkVerError'] = 'Error de connexiÃ³.';
