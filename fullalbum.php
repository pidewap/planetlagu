...
$f=file('http://www.planetlagu.site/category/download-lagu/full-album/'.$nub.'/');
$gg=@implode($f);
...
$bod=str_replace('href="http://www.planetlagu.site/category/download-lagu/full-album/page/', 'href="?page=', $bod);
